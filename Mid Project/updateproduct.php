...
<html lang="en">
	...
	<body>
		<img src="grocery.jpg"  width="1350" height="200">
		<fieldset style=" text-align: center;"><h1 >UpdateProduct</h1>
			<form action="" method="post">
				<table style="margin-left: auto; margin-right: auto;">
					...
					<tr>
						<td></td>
						<td><input type="submit" name="" style="padding: 10px 30px; " value="UPDATE"></td>
					</tr>
