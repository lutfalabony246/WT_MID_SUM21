...
$daycreate = array("1","2","3","4");
$monthcreate = array("1","2","3","4");
$yearcreate = array("2001","2002","2003","2004");
...
<html lang="en">
	...
	<body>
		<img src="grocery.jpg" style="display: inline-block;" width="1350" height="200">
		<fieldset style="background: #C688F7; text-align: center;"><h1 style="color: red;">UpdateProduct</h1>
			<form action="" method="post">
				<table style="margin-left: auto; margin-right: auto;">
					...
					<tr>
						<td></td>
						<td><input type="submit" name="" style="padding: 10px 30px; color: red; background:#CBB2AD  ;" value="UPDATE"></td>
					</tr>
